...
const AuthPage = () => {
  ...
  const isSurveyComplete = () => {
    return (
      surveyData.leagueRating !== undefined && surveyData.leagueRating !== null &&
      surveyData.tournamentRating !== undefined && surveyData.tournamentRating !== null &&
      surveyData.tournamentsYearly && surveyData.tournamentsYearly !== '' &&
      surveyData.leagueFrequency && surveyData.leagueFrequency !== '' &&
      surveyData.purposeOfPlay && surveyData.purposeOfPlay !== '' &&
      surveyData.practiceTime && surveyData.practiceTime !== '' &&
      surveyData.coachingFrequency && surveyData.coachingFrequency !== '' &&
      surveyData.favoriteClubs && surveyData.favoriteClubs !== ''
    );
  };
                ...
                <TabsContent value="signup">
                  {signupStep === 1 ? (
                    ...
                    <div className="space-y-4">
                      ...
                      <Button 
                        onClick={async () => {
                          // All users must complete survey before signup
                          setSignupStep(3);
                        }}
                    ...
                    <div className="space-y-4 max-h-96 overflow-y-auto">
                      ...
                      <Button 
                        onClick={async () => {
                          // Validate survey is complete before allowing signup
                          if (!isSurveyComplete()) {
                            toast({
                              title: "Survey Incomplete",
                              description: "Please complete all survey questions before creating your account",
                              variant: "destructive",
                            });
                            return;
                          }
                        ...
                        title={!isSurveyComplete() ? 'Please complete all survey questions' : ''}
                      >
